...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        I am Harshit, currently in Newton School of Technology, pursuing CS & AI
        B.Tech.{" "}
      </span>
      <span
      ...
      >
        Philomath interested in AI and UI/UX, making new projects which can be
        implemented in real-life use.
      </span>
    </h1>
  );
