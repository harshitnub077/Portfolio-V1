...
const TimelineSection = ({ isDesktop }: IDesktop) => {
  ...
  const animateTimeline = useCallback(
    ...
    [
      addConvergingBranchLineAnimation,
      addDivergingBranchLineAnimation,
      addLineSvgAnimation,
    ]
  );
  ...
  }, [isDesktop, svgLength, svgCheckpointItems.length]);
  ...
  }, [animateTimeline, initScrollTrigger, setTimelineSvg, svgContainer, timelineSvg]);
